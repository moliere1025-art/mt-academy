...
function stripTitleUppercase(file) {
  ...
  s = s.replace(/font-bold uppercase tracking-tight font-display/g, 'font-bold tracking-tight font-display');
  s = s.replace(/font-bold uppercase tracking-tight text-ink font-display/g, 'font-bold tracking-tight text-ink font-display');
  s = s.replace(/text-xl font-bold uppercase tracking-tight font-display text-ink/g, 'text-xl font-bold tracking-tight font-display text-ink');
  s = s.replace(/text-2xl font-bold uppercase tracking-tight font-display text-ink/g, 'text-2xl font-bold tracking-tight font-display text-ink');
  s = s.replace(/text-2xl sm:text-3xl md:text-4xl font-bold uppercase tracking-tight font-display leading-tight/g, 'text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight font-display leading-tight');
  s = s.replace(/text-4xl md:text-5xl font-display font-bold tracking-tight uppercase leading-\[0\.94\] text-ink/g, 'text-4xl md:text-5xl font-display font-bold tracking-tight leading-[0.94] text-ink');
  s = s.replace(/text-lg font-bold uppercase tracking-tight font-display leading-tight mb-3/g, 'text-lg font-bold tracking-tight font-display leading-tight mb-3');
  s = s.replace(/text-lg font-bold uppercase tracking-tight text-ink font-display/g, 'text-lg font-bold tracking-tight text-ink font-display');
  s = s.replace(/text-2xl font-bold tracking-tight uppercase text-ink font-display/g, 'text-2xl font-bold tracking-tight text-ink font-display');
  s = s.replace(/text-xl font-bold uppercase tracking-tight font-display leading-tight text-ink/g, 'text-xl font-bold tracking-tight font-display leading-tight text-ink');
  s = s.replace(/text-xl font-bold uppercase tracking-tight font-display text-ink/g, 'text-xl font-bold tracking-tight font-display text-ink');
